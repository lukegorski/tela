/**
 * Server-side (Node runtime) Sentry init for apps/admin. Catches SSR /
 ...
 * they'd vanish.
 *
 * Loaded by apps/admin/src/instrumentation.ts via runtime branching.
 *
...
Sentry.init({
  dsn: process.env.NEXT_PUBLIC_SENTRY_DSN_ADMIN ?? process.env.SENTRY_DSN_ADMIN,
